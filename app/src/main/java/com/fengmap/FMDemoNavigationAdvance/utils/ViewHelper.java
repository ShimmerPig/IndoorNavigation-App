...
public class ViewHelper {
    ...
    public static FMImageMarker buildImageMarker(Resources resources, FMMapCoord mapCoord) {
        return buildImageMarker(resources, mapCoord, R.drawable.ic_marker_blue);
    }
     ...
     * @return 定位标注
     */
    public static FMLocationMarker buildLocationMarker(int groupId, FMMapCoord mapCoord, float angle, int resID) {
        FMLocationMarker locationMarker = new FMLocationMarker(groupId, mapCoord);
        //设置定位点图片
